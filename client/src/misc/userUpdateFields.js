const userUpdateFields = [
    ...
    { label: 'Old Password', name: 'password', type: 'password', errorMsg: 'Old Password is required' },
    { label: 'New Password', name: 'password', type: 'password', errorMsg: 'New Password is required' },
    { label: 'Confirm New Password', name: 'confirmPassword', type: 'password', errorMsg: 'Passwords do not match' }
  ]
