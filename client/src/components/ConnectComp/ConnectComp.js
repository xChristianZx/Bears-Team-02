		...
		<div>
			<nav>
				<ul className="flexbox-container" role="navigation">
					...
					<li className="menu-item" id="log-out">
						<a href="#">Logout</a>
					</li>
				</ul>
			</nav>
				...
				<section className="search-area level">
					<div className="search level-item">
						<p className="control">
							<input
								type="text"
								className="level-item  search-input"
								placeholder="Search Founder Connect"
							/>
						</p>
						<p className="control">
							<button className="button level-item" id="search-button">
								Search
							</button>
						</p>
					</div>
								...
								<li className="box" id="results-item">
									...
									<div className="media-content">
										<div className="content">
											<p>
												<strong>{user.firstName} {user.lastName}</strong> <small>@{user.username}</small> <small>31m</small>
												<br />
												Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean
												efficitur sit amet massa fringilla egestas. Nullam condimentum luctus
												turpis. Tiger american bobtail. Balinese grimalkin puma tiger. Sphynx
												burmese. Lion devonshire rex tomcat. Tomcat himalayan for manx so bobcat
												burmese, siamese yet tabby. Tiger turkish angora.
											</p>
										</div>
									</div>
								</li>
